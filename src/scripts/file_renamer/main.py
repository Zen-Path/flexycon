...
CONVERTERS: list[ConverterRow] = [
    ...
    ConverterRow(
        ...
        transform_func=lambda text: to_lower_case(text, "-"),
    ),
    ConverterRow(
        short="-K",
        long="--kebab-upper-case",
        description="KEBAB-CASE",
        transform_func=lambda text: to_upper_case(text, "-"),
    ),
    ConverterRow(
        short="-s",
        long="--snake-case",
        description="snake_case",
        transform_func=lambda text: to_lower_case(text, "_"),
    ),
    ConverterRow(
        short="-S",
        long="--snake-upper-case",
        description="SNAKE_UPPER",
        transform_func=lambda text: to_upper_case(text, "_"),
    ),
    ConverterRow(
        short="-p",
        long="--pascal-case",
    ...
    ConverterRow(
        short="-P",
        long="--pascal-snake-case",
        description="Pascal_Snake_Case",
        transform_func=lambda text: to_pascal_case(text, "_"),
    ),
    ConverterRow(
        short="-t",
        long="--train-case",
        description="Train-Case",
        transform_func=lambda text: to_pascal_case(text, "-"),
    ),
    ConverterRow(
        short="-l",
        long="--lower-case",
